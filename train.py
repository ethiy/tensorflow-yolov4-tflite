...
def main(_argv):
    ...
    input_layer = tf.keras.layers.Input(
        [cfg.TRAIN.INPUT_HEIGHT, cfg.TRAIN.INPUT_WIDTH, 3]
    )
    ...
    if FLAGS.tiny:
        ...
        for i, fm in enumerate(feature_maps):
            if i == 0:
                bbox_tensor = decode_train(
                    fm,
                    cfg.TRAIN.INPUT_HEIGHT // 16,
                    cfg.TRAIN.INPUT_WIDTH // 16,
                    NUM_CLASS,
                    STRIDES,
                    ANCHORS,
                    i,
                ...
                bbox_tensor = decode_train(
                    fm,
                    cfg.TRAIN.INPUT_HEIGHT // 32,
                    cfg.TRAIN.INPUT_WIDTH // 32,
                    NUM_CLASS,
                    STRIDES,
                    ANCHORS,
                    i,
        ...
        for i, fm in enumerate(feature_maps):
            if i == 0:
                bbox_tensor = decode_train(
                    fm,
                    cfg.TRAIN.INPUT_HEIGHT // 8,
                    cfg.TRAIN.INPUT_WIDTH // 8,
                    NUM_CLASS,
                    STRIDES,
                    ANCHORS,
                    i,
